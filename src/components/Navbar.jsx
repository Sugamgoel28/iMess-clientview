  ...
  return (
    <nav className="flex items-center justify-between p-4 bg-purple-600">
      <div className="flex items-center">
        <img src={nitrLogo} alt="NITR Logo" className="h-8 mr-4" />
        {/* Company Name */}
      ...
      <div className="flex items-center ">
        ...
        <span className="p-2 mx-1 text-white transition duration-300 ease-in-out border cursor-pointer hover:text-blue-300 hover:border-blue-300">
